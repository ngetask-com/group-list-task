import { capitalize, Fragment, reactive, computed, watchEffect, toRefs, warn, ref, inject as inject$1, unref, provide, shallowRef, defineComponent as defineComponent$1, camelize, h, getCurrentInstance as getCurrentInstance$1, createVNode, TransitionGroup, Transition, mergeProps, watch, onBeforeMount, nextTick, onBeforeUnmount, withDirectives, resolveDirective, vShow, isRef, onScopeDispose, effectScope, toRaw, toRef, readonly, onDeactivated, onActivated, onMounted, Text, resolveDynamicComponent, withCtx, createTextVNode, useSSRContext, createSSRApp } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VLayout, mergeProps({ class: "rounded rounded-md" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "AAAA" }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VAppBar, { title: "Application bar" }, null, _parent2, _scopeId));
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VList, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VListItem, { title: "Navigation drawer" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(VListItem, { title: "Navigation drawer" })
                        ];
                      }
                    }),
                    _: 1
            ...
            return [
              createVNode(unref(Head), { title: "AAAA" }),
              createVNode(VAppBar, { title: "Application bar" }),
